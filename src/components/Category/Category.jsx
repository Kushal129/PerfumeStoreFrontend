    ...
    return (
        <div className='py-8'>
            <div className='container mx-auto'>
                <div className='grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 m-2'>
                    ...
                    >
                        <div>
                            ...
                            <p className='text-4xl lg:text-5xl sm:text-[20px] font-bold opacity-40 mb-2'>HACOSTE WHITE</p>
                        </div>
                        ...
                        <motion.img
                            src={Img1}
                            className='absolute bottom-0 right-0 h-full object-contain p-5 lg:w-[230px]'
                    ...
                    <motion.div
                        ref={ref3}
                        className='bg-gradient-to-br from-primarycat/90 to-primary/90 dark:from-brandWhite/90 dark:to-bgdark/90 text-brandWhite rounded-3xl h-[320px] flex flex-col justify-between p-5 relative col-span-2'
                        initial={{ opacity: 0, y: 50 }}
                    ...
                    >
                        ...
                        <motion.img
                            src={Img3}
                            className='absolute bottom-0 right-0 h-full object-contain p-5 lg:w-[320px]'
                            initial={{ opacity: 0, x: 50 }}
