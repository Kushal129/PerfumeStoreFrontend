        ...
        <div className='py-8' >
            <div className='container'>
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
                    {/* first col */}
                    <div className='col-span-2 py-10 pl-5 bg-gradient-to-br from-primary/90 dark:from-brandWhite dark:to-bgdark/90 to-primary/90 text-brandWhite 
                rounded-3xl relative h-[320px] flex items-start'>
                        ...
                        <img
                            src={Img1}
                            className='w-[360px] absolute -bottom-8 -right-[1rem]' />
                    </div>
